...
import 'package:phitnest/old/model/User.dart';
import 'package:phitnest/old/services/FirebaseHelper.dart';
import 'package:phitnest/old/services/helper.dart';
import 'package:phitnest/old/ui/screens/accountDetails/AccountDetailsScreen.dart';
import 'package:phitnest/old/ui/screens/auth/AuthScreen.dart';
import 'package:phitnest/old/ui/screens/contactUs/ContactUsScreen.dart';
import 'package:phitnest/old/ui/screens/fullScreenImageViewer/FullScreenImageViewer.dart';
import 'package:phitnest/old/ui/screens/reauthScreen/reauth_user_screen.dart';
import 'package:phitnest/old/ui/screens/settings/SettingsScreen.dart';
              ...
              ListTile(
                ...
                onTap: () async {
                  ...
                  if (result != null && result) {
                    ...
                    await hideProgress();
                    PhitnestAppState.currentUser = null;
      ...
      actions: <Widget>[
        CupertinoActionSheetAction(
          onPressed: () async {
            ...
            PhitnestAppState.currentUser = newUser;
            if (newUser != null) {
              user = newUser;
              images.add(null);
              setState(() {});
