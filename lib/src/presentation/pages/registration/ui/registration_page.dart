                      ...
                      children: [
                        Expanded(
                          child: PageView.builder(
                            ...
                            controller:
                                context.read<RegistrationBloc>().pageController,
                              ...
                              switch (index) {
                                case 0:
                                  return PageOne(
                                    ...
                                    firstNameFocusNode: bloc.firstNameFocusNode,
                                    lastNameFocusNode: bloc.lastNameFocusNode,
                                    onSubmit: () =>
                                        context.read<RegistrationBloc>().add(
                                              SubmitPageOneEvent(),
                                            ),
                                ...
                                case 1:
                                  return PageTwo(
                                    ...
                                    firstName:
                                        bloc.firstNameController.text.trim(),
                                  );
                                case 2:
                                  ...
                                  final List<GymEntity> Function(
                                          List<GymEntity>)
                                      filterDuplicateNames = (gyms) => gyms
                                          .where(
                                            (element) =>
                                                gyms
                                                    .where(
                                          ...
                                          .toList();
                                  final ValueChanged<GymEntity> onSelectedGym =
                                      (gym) =>
                                          context.read<RegistrationBloc>().add(
                                  ...
                                  if (state is InitialState) {
                                    ...
                                    return PageThreeSelected(
                                      firstName: firstName,
                                      gyms: filterDuplicateNames(state.gyms),
                                    ...
                                    onPressedNo: () => Navigator.push(
                                      ...
                                      CupertinoPageRoute<GymEntity?>(
                                        builder: (context) => GymSearchPage(
                                          ...
                                          location: gymSelectionState.location,
                                ...
                                case 5:
                                  ...
                                  final VoidCallback onSubmit = () => context
                                      .read<RegistrationBloc>()
                                      .add(RegisterEvent());
                                  if (state is RegisterErrorState) {
                                    ...
                                    return PageSixCaptureError(
                                      ...
                                      onUploadPicture: onUploadPicture,
                                      onPressTakePicture: onPressTakePicture,
                                      errorMessage: state.failure.message,
                                    );
