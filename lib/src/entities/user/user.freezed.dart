...
class _$_UserEntity with DiagnosticableTreeMixin implements _UserEntity {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserEntity(id: $id, email: $email, gymId: $gymId, firstName: $firstName, lastName: $lastName, confirmed: $confirmed)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, email, gymId, firstName, lastName, confirmed);
...
abstract class _UserEntity implements UserEntity {
  const factory _UserEntity(
      ...
      required final bool confirmed}) = _$_UserEntity;
